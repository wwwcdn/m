$(function(){
	...
	if($widthwindow < 350){	$("#wzgx .zjgxjj").fadeOut(500);}
	if($("#xinxi").width()-$("#xinxi .xx ul li").width() <110){$("#xinxi .xx ul li").width($("#xinxi").width()-110)}
	$("#wzlb .spage").click(function(){$("#wzlb .showpage").show(300);	$("#spagebg").css("opacity","0.7").fadeIn(500).height($("body").height());	});
	$("#spagebg").click(function(){$(this).fadeOut(700);$("#wzlb .showpage").hide(300);});
});
$(function(){
...
function huyan_hy(type){if(type=="off"){$("#huyan").html("关护眼");$("#wz").addClass("huyanbg");$("#wz .dise").removeClass("dise").removeClass("header").addClass("huyanbg_br").addClass("huyanbg").addClass("tmpc");$.cookie("huyan","off",{path:'/',expires:365})}else{$("#huyan").html("护眼");$("#wz").removeClass("huyanbg");$("#wz .tmpc").removeClass("huyanbg_br").removeClass("huyanbg").addClass("dise");$("header").addClass("header");$.cookie("huyan","on",{path:'/',expires:365})}}
...
function font(type,fontSize){
	...
	$("#kw").css("font-size",fontSize);
}
function light(type){if(type=="off"){$("#wz #light").html("开灯");$("#wz").removeClass("huyanbg").addClass("gd");$("#wz .dise").removeClass("dise").removeClass("header").addClass("gddise").addClass("tmpc");$.cookie("light","off",{path:'/',expires:365})}else{$("#wz #light").html("关灯");$("#wz").removeClass("gd");$("#wz .tmpc").removeClass("gddise").removeClass("huyanbg").addClass("dise");$("header").addClass("header");$.cookie("light","on",{path:'/',expires:365})}
}
function zyfy(url){
